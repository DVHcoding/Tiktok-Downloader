...
servconf.add_argument(
    "--host", type=str, default="127.0.0.1", help="Set host to run this web"
)
...
cli.add_argument(
    "--info", action="store_true", help="Print info video like author, id & etc"
)
...
out.add_argument(
    "--save", type=argparse.FileType("wb"), help="Write the result to file"
)
